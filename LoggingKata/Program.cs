        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int j = 0; j < locations.Length; j++)
                {
                    ...
                    // Create a new Coordnate with your locB's lat and long
            ...
            // Once you've looped through everything, you've found the two TacoBells farthest away from each other.
            logger.LogInfo($"{tacoBell1.Name} and {tacoBell2} are the farthest apart");
